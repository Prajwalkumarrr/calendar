...
export function getProviders(): ProviderMeta[] {
  return [
    ...
    },
    {
      ...
      category: 'calendar',
      description: 'Two-way sync with Outlook Calendar. Events you create in ElevAIte appear in Outlook and vice versa.',
      status: envSet('MS_CLIENT_ID', 'MS_CLIENT_SECRET') ? 'available' : 'needs-credentials',
      envHint: 'MS_CLIENT_ID + MS_CLIENT_SECRET — register an app at https://portal.azure.com → App registrations',
